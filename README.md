...
**Live at [obligationfirst.org](https://obligationfirst.org/). Drafting in public. v0.2.2-draft. Subject to revision before the v0.2 freeze.**
...
| [`/releases/v0.2.2-draft/`](https://obligationfirst.org/releases/v0.2.2-draft/) | Current release package manifest and checksums |
