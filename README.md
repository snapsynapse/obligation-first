...
[![Spec](https://img.shields.io/badge/spec-v0.6.4-orange)](PROTOCOL.md)
...
**Live at [obligationfirst.org](https://obligationfirst.org/). This repository describes the v0.6.4 reference package. Its v0.6 semantic contract is implemented across EveryAILaw, PubLedge, and AI Incident Law. Remaining v1.0 gates are tracked in [ROADMAP.md](ROADMAP.md).**
...
- Contract and diagnostics: https://github.com/snapsynapse/obligation-first/blob/main/reference/contracts/scope-contract-v1.md
- Inventory tooling schema: https://github.com/snapsynapse/obligation-first/blob/main/reference/contracts/scope-inventory-v1.schema.json
- Synthetic evaluation fixtures: https://github.com/snapsynapse/obligation-first/tree/main/reference/fixtures/scope-contract-v1
...
| [`/releases/v0.6.4/`](https://obligationfirst.org/releases/v0.6.4/) | Current release package manifest and checksums |
